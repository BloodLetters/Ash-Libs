...
local function getResponsiveSize()
    ...
    if screenSize.X < 800 then
        return UDim2.new(0, math.min(screenSize.X - 40, 350), 0, math.min(screenSize.Y - 40, 400))
    else
        return UDim2.new(0, 500, 0, 400)
    end
end
...
function GUI:CreateMain(config)
    settings = {
        ...
        Transparent = {
            Enable = config.Transparent and config.Transparent.Enable or false,
            value = config.Transparent and config.Transparent.value or 0.5
        },
        Config = {
    ...
    if config.Theme then
        Theme = {}
        for key, value in pairs(Default.Theme) do
            Theme[key] = config.Theme[key] or Default.Theme[key]
        end
    end
    ...
    MainFrame.BackgroundTransparency = settings.Transparent.Enable and settings.Transparent.value or 0
    ...
    NavFrame.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.1, 0.9) or 0
    ...
    SettingsFrame.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.1, 0.9) or 0
    ...
    SettingsButton.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.2, 0.9) or 0
    ...
    ContentContainer.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.1, 0.9) or 0
...
-- Element
function GUI:CreateTab(name, iconId)
    ...
    TabButton.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.2, 0.9) or 0
    ...
    TabButton.MouseButton1Click:Connect(function()
        ...
        for _, tab in pairs(GUI.Tabs) do
            tab.Content.Visible = false
            tab.Button.BackgroundColor3 = Theme.Secondary
            tab.Button.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.2, 0.9) or 0
        ...
        TabButton.BackgroundTransparency = settings.Transparent.Enable and settings.Transparent.value or 0
        ...
        TweenService:Create(TabButton, TweenInfo.new(0.2, Enum.EasingStyle.Quart), {
            BackgroundColor3 = Theme.Accent,
            BackgroundTransparency = settings.Transparent.Enable and settings.Transparent.value or 0
        }):Play()
...
function GUI:CreateSlider(config)
    ...
    SliderFrame.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.2, 0.9) or 0
    ...
    Bar.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.1, 0.8) or 0
    ...
    Fill.BackgroundTransparency = settings.Transparent.Enable and settings.Transparent.value or 0
    ...
    Knob.BackgroundTransparency = settings.Transparent.Enable and settings.Transparent.value or 0
...
function GUI:CreateButton(config)
    ...
    ButtonFrame.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.2, 0.9) or 0
    ...
    Button.BackgroundTransparency = settings.Transparent.Enable and settings.Transparent.value or 0
...
function GUI:CreateToggle(config)
    ...
    ToggleFrame.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.2, 0.9) or 0
    ...
    ToggleButton.BackgroundTransparency = settings.Transparent.Enable and settings.Transparent.value or 0
...
function GUI:CreateDropdown(config)
    ...
    DropdownFrame.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.2, 0.9) or 0
    ...
    DropdownButton.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.1, 0.8) or 0
    ...
    DropdownList.BackgroundTransparency = settings.Transparent.Enable and settings.Transparent.value or 0
    ...
    local function createOptionButton(option)
        ...
        OptionButton.MouseEnter:Connect(function()
            ...
            OptionButton.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.2, 0.8) or 0.8
        end)
...
function GUI:CreateKeyBind(config)
    ...
    KeyBindFrame.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.2, 0.9) or 0
    ...
    KeyBindButton.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.1, 0.8) or 0
    ...
    local function startListening()
        ...
        KeyBindButton.BackgroundTransparency = settings.Transparent.Enable and settings.Transparent.value or 0
...
function GUI:CreateInput(config)
    ...
    InputFrame.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.2, 0.9) or 0
    ...
    TextBox.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.1, 0.8) or 0
...
function GUI:CreateParagraph(config)
    ...
    ParagraphFrame.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.2, 0.9) or 0
...
function GUI:CreateSection(config)
    ...
    -- Divider.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.3, 0.9) or 0
...
function GUI:CreateColorPicker(config)
    ...
    ColorPickerFrame.BackgroundTransparency = settings.Transparent.Enable and math.min(settings.Transparent.value + 0.2, 0.9) or 0
    ...
    ColorButton.BackgroundTransparency = settings.Transparent.Enable and settings.Transparent.value or 0
